...
Falls du dieses Dokument direkt ins Repo übernehmen willst, sind diese Namen plausibel:

- `docs/specs/KG_MERGE_AND_OVERLAY_ARCHITECTURE.md`  ← mein Favorit
- `docs/specs/USER_OVERLAY_AND_MERGE_MODEL.md`
- `docs/specs/CLAIM_EVIDENCE_STANCE_ARCHITECTURE.md`
- `docs/specs/RESEARCH_OS_MEMORY_SYNTHESIS.md`
