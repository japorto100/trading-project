...
> **Inhalt verteilt in:** `docs/specs/ARCHITECTURE.md`, `docs/CONTEXT_ENGINEERING.md`, `docs/MEMORY_ARCHITECTURE.md`, `docs/UNIFIED_INGESTION_LAYER.md`, `docs/specs/API_CONTRACTS.md`  
> Dieses Dokument dient nur noch als Retrieval-/Discovery-Referenz.

> **Status (09. Maerz 2026):** Retrieval-/Discovery-Referenz und Quellenmaterial,
> nicht aktive Root-Verfassung. Normative Ableitungen werden in
> `CONTEXT_ENGINEERING.md`, `MEMORY_ARCHITECTURE.md`,
> `KG_MERGE_AND_OVERLAY_ARCHITECTURE.md` und die Specs uebernommen.
...
- Go
- gRPC
- Kafka / NATS (wenn Event-getrieben; für uns NATS JetStream, nicht Kafka)
...
**Aladdin-Gap (RAG-Pipeline):** Agent-Portfolio-Berichte mit Retrieval. OSS-Optionen: LangChain, LlamaIndex, ChromaDB (bereits in deps). Priorität: Niedrig. Event-Backbone: Für uns NATS JetStream (nicht Kafka) – siehe Master_master §8.5.
