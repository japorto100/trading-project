...
> **Inhalt verteilt in:** `docs/specs/DOCUMENTATION_ARCHITECTURE.md`, `docs/specs/EXECUTION_PLAN.md`, `docs/README.md`
> Dieses Dokument bleibt als historischer Transfer-/Audit-Trace erhalten.

## 0. Zweck

Dieses Dokument ist die operative Folgearbeit zu
`Master_master_architecture_2026_IMPORTANT.md`.
...
> **Hinweis (09. Maerz 2026):** Aeltere Verweise in dieser Matrix auf
> `master_master_architecture_2026.md` meinen die heutige Datei
> `Master_master_architecture_2026_IMPORTANT.md`.
...
- `Master_master_architecture_2026_IMPORTANT.md` — Gesamtsynthese und normative Zielarchitektur
...
**ALADDIN-INSIGHTS-FROM-GEMINI-RESEARCH.md:** Verteilung abgeschlossen (März 2026). Archiv: `docs/archive/ALADDIN-INSIGHTS-FROM-GEMINI-RESEARCH.md`

### 2.3 Arbeits-, Pilot-, Migrations- und Randdokumente

Diese Dokumente bleiben wichtig, sind aber nicht die **eine** Root-Verfassung.
Einige davon sind trotzdem aktive Sources of Truth fuer ihren klaren Scope
(z. B. `SYSTEM_STATE.md` als kompakte IST/SOLL-Wahrheit).
...
| Quelle | Primäre Rolle | Aktion | Was hochziehen | Was lokal lassen | Ziel(e) |
|---|---|---:|---|---|---|
| `execution/cross_cutting_verify.md` | operative Kurz-Checkliste | REFERENCE | nur wenn Gates/Abhängigkeiten illustriert werden sollen | konkrete To-dos | `EXECUTION_PLAN.md` |
| `execution/compute_delta.md` | Indikator-/Buch-Nähe-Plan | REFERENCE | nur wo Indicator/Rust-Pfade geschärft werden | operative Detailplanung | `EXECUTION_PLAN.md`, `INDICATOR_ARCHITECTURE.md` |
| `execution/infra_provider_delta.md` | Infra-/Provider-/Rollout-Delta | SPLIT | Go as orchestrator, Rust service boundary, Connect/NATS-Impuls, Python aus Hot Path | Sprint-/Tasks, pkg-Struktur, Verify-Gates | `master_master_architecture_2026.md`, `ARCHITECTURE.md`, `EXECUTION_PLAN.md` |
...
| 24 | WebGPU & deck.gl | `GEOPOLITICAL_MAP_MASTERPLAN.md`, `GEOMAP_VERIFY.md`, `GEOMAP_FOUNDATION.md`, `EXECUTION_PLAN.md` | Geo-/Rendering-Entscheidung, gate-basiert |
...
| 31 | Spatial Data Architecture | `GEOPOLITICAL_MAP_MASTERPLAN.md`, `GEOMAP_VERIFY.md`, `GEOMAP_FOUNDATION.md` | `PMTiles`, `FlatGeobuf`, `deck.gl`, `Three.js`, `D3.js` |
...
- `execution/*.md` (ehem. `execution_mini_plan*.md`)  
  bleiben nützlich als operative Notizschicht unter `docs/specs/execution/`.
...
11. `execution/*.md` stärker an neue Ziel-Docs hängen
