...
> **Status (09. Maerz 2026):** Externe Feature-/Referenznotiz, nicht normative
> Projektarchitektur. Relevante projektbezogene Agent-/Tool-Entscheidungen leben
> in `docs/AGENT_TOOLS.md` und `docs/AGENT_ARCHITECTURE.md`.
