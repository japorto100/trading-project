...
- **Optional (v3+):** Bei 5.000+ Events: supercluster-Berechnung in Web Worker auslagern. Worker empfängt Punkte + Bounds + Zoom, postet Cluster-Ergebnis zurück. Main-Thread rendert nur. Siehe [`GEOMAP_VERIFY.md`](./GEOMAP_VERIFY.md) Sek. 4 Szenario C.
...
| [`docs/references/sources/financial-stability-and-nbfi.md`](./references/sources/financial-stability-and-nbfi.md) | Basel Regime, Currency Spread, Stress- und Stability-Quellen |
