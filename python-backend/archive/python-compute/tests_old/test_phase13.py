...
from indicator_engine.portfolio_analytics import (  # noqa: E402
    AssetFullOHLCV,
    AssetOHLCV,
    KellyRequest,
    MonteCarloRequest,
...
def test_hrp_weights_sum_to_one():
    async def inner():
        with patch(
            "indicator_engine.portfolio_analytics.fetch_ohlcv_from_go",
...
def test_vpin_value_in_unit_range():
    async def inner():
        with patch(
            "indicator_engine.portfolio_analytics.fetch_full_ohlcv_from_go",
