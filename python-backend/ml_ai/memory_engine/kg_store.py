"""KuzuDB-backed Knowledge Graph store with SQLite fallback.
...
DB path: python-backend/data/kuzu/ (created at init)
"""
...
def create_kg_store(db_path: str | None = None) -> KuzuKGStore | SQLiteKGStore:
    if _FORCE_SQLITE:
