...
type GCTExchange interface {
	...
	QueryOrder(ctx context.Context, exch, orderid string, pair currency.Pair, assetType string) (*order.Detail, error)
	...
	AccountBalances(ctx context.Context, exch string, assetType string) (accounts.SubAccounts, error)
