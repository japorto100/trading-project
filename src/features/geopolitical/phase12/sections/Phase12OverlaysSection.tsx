...
interface Phase12OverlaysSectionProps {
...
export function Phase12OverlaysSection(props: Phase12OverlaysSectionProps) {
	return (
		<section className="rounded border border-border bg-background p-2">
			...
			<div className="grid gap-2 sm:grid-cols-2">
				<label className="flex items-center gap-2 text-xs">
					<input
						id="phase12-overlay-rate-decisions"
						name="phase12_overlay_rate_decisions"
						type="checkbox"
				...
				<label className="flex items-center gap-2 text-xs">
					<input
						id="phase12-overlay-cbdc-choropleth"
						name="phase12_overlay_cbdc_choropleth"
						type="checkbox"
				...
				<label className="flex items-center gap-2 text-xs">
					<input
						id="phase12-overlay-dedollarization"
						name="phase12_overlay_dedollarization"
						type="checkbox"
				...
				<label className="flex items-center gap-2 text-xs">
					<input
						id="phase12-overlay-financial-openness"
						name="phase12_overlay_financial_openness"
						type="checkbox"
