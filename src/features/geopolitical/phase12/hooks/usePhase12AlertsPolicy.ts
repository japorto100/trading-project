...
const SEVERITY_BY_VALUE: Record<number, AlertSeverityThreshold> = {
	1: "low",
	2: "medium",
	3: "high",
	4: "critical",
...
export function usePhase12AlertsPolicy(events: GeoEvent[]) {
	...
	const [alertsPreviewResponse, setAlertsPreviewResponse] = useState<AlertsPreviewResponse | null>(
		null,
	);
