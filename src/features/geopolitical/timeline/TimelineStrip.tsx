...
import { buildGeoTimelineTimeFocus } from "@/features/geopolitical/timeline/timeline-focus";
import {
...
} from "@/features/geopolitical/timeline/timeline-presets";
import {
...
export function TimelineStrip({
	...
	const densityAnnotation = useMemo(() => {
		...
		const firstCandidatePoint = candidatePoints[0];
		if (!firstCandidatePoint) return null;
