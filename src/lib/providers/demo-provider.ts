...
const DEMO_SYMBOLS: SymbolConfig[] = [
  // Crypto
  { symbol: 'BTC/USD', name: 'Bitcoin', type: 'crypto', basePrice: 67500, volatility: 0.03, trend: 0.0001 },
  { symbol: 'ETH/USD', name: 'Ethereum', type: 'crypto', basePrice: 3450, volatility: 0.035, trend: 0.00015 },
  { symbol: 'SOL/USD', name: 'Solana', type: 'crypto', basePrice: 178, volatility: 0.045, trend: 0.0002 },
  { symbol: 'XRP/USD', name: 'Ripple', type: 'crypto', basePrice: 0.52, volatility: 0.04, trend: 0.00005 },
  // Stocks
  { symbol: 'AAPL', name: 'Apple Inc.', type: 'stock', basePrice: 189, volatility: 0.015, trend: 0.0001 },
  { symbol: 'GOOGL', name: 'Alphabet Inc.', type: 'stock', basePrice: 175, volatility: 0.018, trend: 0.00008 },
  { symbol: 'MSFT', name: 'Microsoft', type: 'stock', basePrice: 420, volatility: 0.014, trend: 0.00012 },
  { symbol: 'TSLA', name: 'Tesla Inc.', type: 'stock', basePrice: 248, volatility: 0.028, trend: -0.00005 },
  { symbol: 'NVDA', name: 'NVIDIA', type: 'stock', basePrice: 880, volatility: 0.025, trend: 0.0002 },
  { symbol: 'AMZN', name: 'Amazon', type: 'stock', basePrice: 185, volatility: 0.016, trend: 0.0001 },
  // FX
  { symbol: 'EUR/USD', name: 'Euro/US Dollar', type: 'fx', basePrice: 1.0850, volatility: 0.003, trend: 0.00001 },
  { symbol: 'GBP/USD', name: 'British Pound/US Dollar', type: 'fx', basePrice: 1.2720, volatility: 0.004, trend: 0.00002 },
  { symbol: 'USD/JPY', name: 'US Dollar/Japanese Yen', type: 'fx', basePrice: 154.50, volatility: 0.003, trend: -0.00001 },
  // Indices
  { symbol: 'SPX', name: 'S&P 500 Index', type: 'index', basePrice: 5320, volatility: 0.008, trend: 0.00005 },
  { symbol: 'DJI', name: 'Dow Jones Industrial Average', type: 'index', basePrice: 39500, volatility: 0.006, trend: 0.00003 },
  { symbol: 'NDX', name: 'Nasdaq 100 Index', type: 'index', basePrice: 18600, volatility: 0.01, trend: 0.00008 },
];
...
export class DemoProvider implements MarketDataProvider {
  ...
  async fetchOHLCV(
    ...
    for (let i = 0; i < limit; i++) {
      ...
      const baseVolume = config.type === 'crypto' ? 1000000 : 
                         config.type === 'fx' ? 500000 :
                         config.type === 'index' ? 200000 : 5000000;
  ...
  async searchSymbols(query: string): Promise<SymbolResult[]> {
    ...
    const results = DEMO_SYMBOLS.filter(s => 
