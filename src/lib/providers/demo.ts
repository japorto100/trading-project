...
const SYMBOL_CONFIG: Record<string, { name: string; type: SymbolResult['type']; basePrice: number; volatility: number; exchange?: string }> = {
  // Crypto
  ...
  // US Stocks
  'AAPL': { name: 'Apple Inc.', type: 'stock', basePrice: 189, volatility: 0.015, exchange: 'NASDAQ' },
  'GOOGL': { name: 'Alphabet Inc.', type: 'stock', basePrice: 175, volatility: 0.018, exchange: 'NASDAQ' },
  'MSFT': { name: 'Microsoft', type: 'stock', basePrice: 420, volatility: 0.014, exchange: 'NASDAQ' },
  'TSLA': { name: 'Tesla Inc.', type: 'stock', basePrice: 248, volatility: 0.028, exchange: 'NASDAQ' },
  ...
  'META': { name: 'Meta Platforms', type: 'stock', basePrice: 505, volatility: 0.02, exchange: 'NASDAQ' },
  'JPM': { name: 'JPMorgan Chase', type: 'stock', basePrice: 198, volatility: 0.012, exchange: 'NYSE' },
  'V': { name: 'Visa Inc.', type: 'stock', basePrice: 280, volatility: 0.011, exchange: 'NYSE' },
  'JNJ': { name: 'Johnson & Johnson', type: 'stock', basePrice: 158, volatility: 0.01, exchange: 'NYSE' },
  ...
  'ASML': { name: 'ASML Holding', type: 'stock', basePrice: 950, volatility: 0.022, exchange: 'EURONEXT' },
