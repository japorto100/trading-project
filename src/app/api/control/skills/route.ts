// GET /api/control/skills — read-only, no-store (AC10, AC11)
...
const DEGRADED_FALLBACK = { skills: [], degraded: true };
...
export async function GET(request: NextRequest) {
	...
	try {
		const res = await fetch(`${getGatewayBaseURL()}/api/v1/control/skills`, {
			headers: {
